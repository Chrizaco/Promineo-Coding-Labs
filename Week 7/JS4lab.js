...
let friendsName = Bobby;
//Question: Name a reason why you would use const instead of let.
//Answer: Const is variable that won't change will let is a variable that can be reassigned.
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log(`${myName} and ${friendsName} are going to eat `);
