 ...
 * ↓ YOUR CODE HERE ↓ */
var myTodoList = [];
myTodoList.push("1", "2", "3");
console.log(myTodoList);
myTodoList.splice(1, 1);
console.log(myTodoList);
var yourTodoList = ["4", "5"];
 ...
 * ↓ YOUR CODE HERE ↓ */
function reverse(x) {
  if (reverse.isBoolean) {
    return reverse.reverse();
  } else if (reverse.isNumber) {
    return reverse.reverse();
  } else if (reverse.isString) {
    return reverse.reverse();
  } else if (x.isArray) {
    return reverse.reverse();
  } else {
...
console.log(whichArrayIsLonger([1, 2, 3, 4], [1, 2, 3, 4])); //should ret
